...
<main>
    ...
    <form action = "shellSort-backend.php" method="get">
        <input type="text" id = "nums-area" class = "nums-area" name = "toSort" value="<?php if (isset($_GET["toSort"])) echo $_GET["toSort"]?>" onkeypress='validate(event)'>
        <br>
        <br>
        ...
        <div class="sorted-wrapper" >
            ...
            <input type="text" class = "nums-area" name = "sorted" value="<?php if (isset($_GET["sorted"])) foreach ($sorted as $num) echo $num, ' '?> " readonly>
        </div>
